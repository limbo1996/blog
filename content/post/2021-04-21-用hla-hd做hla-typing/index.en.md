---
title: "2021 04 21 用HLA HD做HLA Typing"
description: 
date: 2021-06-09T14:43:11+08:00
...
> hlahd.sh \
-t [thread_num] \
-m [minimum length of reads] \
-c [trimming rate] \
-f [path_to freq_data directory] \
fastq_1 fastq_2 gene_split_filt \
path_to_dictionary_directory IDNAME[any name] \ output_directory
```
